...
package com.example.rxjava3adapter.rxpermissions3;
...
import com.jdc.bank.rxpermissions3.Permission;
...
public class RxPermissions {
            ...
            public ObservableSource<Boolean> apply(Observable<T> o) {
                return request(o, permissions)
                        ...
                        .flatMap(new Function<List<Permission>, ObservableSource<Boolean>>() {
                            @Override
                            public ObservableSource<Boolean> apply(List<com.jdc.bank.rxpermissions3.Permission> permissions) {
                                ...
                                for (com.jdc.bank.rxpermissions3.Permission p : permissions) {
                                    if (!p.granted) {
    ...
    /**
     * Map emitted items from the source observable into {@link com.jdc.bank.rxpermissions3.Permission} objects for each
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public <T> ObservableTransformer<T, com.jdc.bank.rxpermissions3.Permission> ensureEach(final String... permissions) {
        return new ObservableTransformer<T, com.jdc.bank.rxpermissions3.Permission>() {
            @Override
            public ObservableSource<com.jdc.bank.rxpermissions3.Permission> apply(Observable<T> o) {
                return request(o, permissions);
            }
        };
    }
    ...
    /**
     * Map emitted items from the source observable into one combined {@link com.jdc.bank.rxpermissions3.Permission} object. Only if all permissions are granted,
     * permission also will be granted. If any permission has {@code shouldShowRationale} checked, than result also has it checked.
     * <p>
     * If one or several permissions have never been requested, invoke the related framework method
     * to ask the user if he allows the permissions.
     */
    public <T> ObservableTransformer<T, com.jdc.bank.rxpermissions3.Permission> ensureEachCombined(final String... permissions) {
        return new ObservableTransformer<T, com.jdc.bank.rxpermissions3.Permission>() {
            @Override
            public ObservableSource<com.jdc.bank.rxpermissions3.Permission> apply(Observable<T> o) {
                return request(o, permissions)
                        .buffer(permissions.length)
                        .flatMap(new Function<List<com.jdc.bank.rxpermissions3.Permission>, ObservableSource<com.jdc.bank.rxpermissions3.Permission>>() {
                            @Override
                            public ObservableSource<com.jdc.bank.rxpermissions3.Permission> apply(List<com.jdc.bank.rxpermissions3.Permission> permissions) {
                                if (permissions.isEmpty()) {
                                    return Observable.empty();
                                }
                                return Observable.just(new com.jdc.bank.rxpermissions3.Permission(permissions));
                            }
                        });
            }
        };
     ...
     */
    @SuppressWarnings({"WeakerAccess", "unused"})
    public Observable<com.jdc.bank.rxpermissions3.Permission> requestEach(final String... permissions) {
     ...
     * of your application</b>.
     */
    public Observable<com.jdc.bank.rxpermissions3.Permission> requestEachCombined(final String... permissions) {
        return Observable.just(TRIGGER).compose(ensureEachCombined(permissions));
    }

    private Observable<com.jdc.bank.rxpermissions3.Permission> request(final Observable<?> trigger, final String... permissions) {
